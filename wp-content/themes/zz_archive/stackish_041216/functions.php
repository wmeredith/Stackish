...
function stck_scripts_styles() {
	if (!is_admin()) {
		...
		wp_register_script('stck_js', get_bloginfo('template_url') . '/js/min/app.min.js', array('jquery'), '', true);
		wp_enqueue_script('stck_js');

        wp_register_script('foudnation_js', get_bloginfo('template_url') . '/bower_components/foundation-sites/dist/foundation.js', array('jquery'), '', true);
		wp_enqueue_script('foudnation_js');
