...
get_header(); ?>
    ...
    <div class="row">       
      <div class="stack-thumb-gallery">
        ...
        <div class="col-lg-3 col-md-4 col-xs-6 stack-thumb-wrap">
          <div class="stack-thumbnail-effects">
            <a class="stack-thumb" href="<?php echo get_the_permalink(); ?>" title="<?php echo get_the_title(); ?>">
              ...
              <img class="img-responsive img-rounded" src="<?php echo $thumb_url; ?>" alt="<?php echo get_the_title(); ?>">
            </a>
          </div>
          <div class="row stack-thumb-meta">
            <div class="col-md-12 stack-thumb-meta-left">
              <ul>
                <li class="stack-thumb-author"><?php echo get_the_author(); ?></li>
                <!-- <li class="stack-thumb-date"><?php echo get_the_date("M d, 'y"); ?></li> -->
